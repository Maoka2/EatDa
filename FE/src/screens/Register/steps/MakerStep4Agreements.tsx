  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={styles.agreementsContainer}>
        <TouchableOpacity style={styles.agreementItem} onPress={() => toggle("terms")}>
          <View
            style={[
              styles.checkbox,
              {
                borderColor: agreements.terms ? COLORS.secondaryMaker : COLORS.inactive,
                backgroundColor: agreements.terms ? COLORS.secondaryMaker : "transparent",
              },
            ]}
          >
        ...
        <TouchableOpacity style={styles.agreementItem} onPress={() => toggle("marketing")}>
          <View
            style={[
              styles.checkbox,
              {
                borderColor: agreements.marketing ? COLORS.secondaryMaker : COLORS.inactive,
                backgroundColor: agreements.marketing ? COLORS.secondaryMaker : "transparent",
              },
            ]}
          >
      ...
      <View style={{ alignItems: "center", marginTop: height * 0.02 }}>
        <Text style={[styles.notice, { fontSize: width * 0.03, textAlign: "center" }]}>
...
const styles = StyleSheet.create({
  ...
  checkbox: {
    ...
    marginRight: 15, marginTop: 2, justifyContent: "center", alignItems: "center",
  },
